// Попробовал реализовать через фреймворк CodeceptJS. Но можно, конечно, было и через playwright.
// P.S. К сожалению, некоторые селекторы вымышлены, тк сессия в аккаунте постоянное сбрасывалась,
// из-за того, что другие пользователи логинились под тестовым юзером.
